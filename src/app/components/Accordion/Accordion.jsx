                ...
                <AccordionDetails sx={{ mt: -2 }}>
                    {selectedValue === 'Spec' && currType === 'Spectrogram' && (
                        <Paragraph sx={{ color: '#696665' }}>
                            Low frequency spectrograms are calculated using a 1 hour
                            Welch-median PSD estimate using a Hann window,
                            1024 FFT points, and 50% overlap.
                        </Paragraph>
                    )}

                    {selectedValue === 'Spec' && currType === 'ST Spectrogram' && (
                        <Paragraph sx={{ color: '#696665' }}>
                            Short term spectrogram is generated by pulling the raw acoustic data directly from OOI. This means that it shouldn't be used for visualizing longer time spans. For longer time span visualizations, use the long-term spectrogram option.
                        </Paragraph>
                    )}

                    {selectedValue === 'Broad' && currType === 'Broadband' && (
                        <Paragraph sx={{ color: '#696665' }}>
                            Spectrograms for broadband hydrophone data are well suited for shorter time durations. For some locations, there might be multiple depth options that need selection.
                            Choose the appropriate parameters, ensure the date range is ideally within one hour for quickest results.
