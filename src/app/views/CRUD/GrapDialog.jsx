...
const GrapDialog = ({ currentLocation, open, handleClose }) => {
    ...
    const handleRadioChange = async (event) => {
        ...
        setEndDate('2020-03-02')
        setError('')
        if (
            event.target.value === 'CTD' &&
            ...
            event.target.value === 'Mete' &&
            Object.keys(initWindRainGraph).length === 0
        ) {
